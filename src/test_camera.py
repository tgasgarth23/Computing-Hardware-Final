...
class FullscreenListApp(tk.Tk):
    def __init__(self):
        ...
        self.cap = cv2.VideoCapture(1)  # Using the first webcam
    ...
    def show_feedback_screen(self):
        print("Showing feedback screen")  # Debug print
    ...
    def return_to_main_screen(self, event=None):
        print("Returning to main screen")  # Debug print
    ...
    def update_webcam_feed(self):
        print("Updating webcam feed")  # Debug print
        if self.webcam_label.winfo_ismapped():
            ...
            print("Webcam label not mapped")  # Debug print
